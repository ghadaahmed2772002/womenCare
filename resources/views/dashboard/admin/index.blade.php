            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <h3>Admins</h3>
                        <a href="{{ route('admin.create') }}" class="btn btn-success float-end" id="btn-new">Add New Admin</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($admins as $admin)
                                    <tr>
                                        ...
                                        <td>{{ $admin->name }}</td>
                                        <td>{{ $admin->email }}</td>
                                        <td><img src="{{ asset('storage/' . $admin->photo) }}" alt="Photo" width="50"></td>

                                        <td>{{ $admin->role }}</td>
                                        <td>
                                            <a href="{{ route('admin.show', $admin->id) }}" class="btn btn-sm btn-secondary">Show</a>
