            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <span class="las la-building"></span> Discounts
                        <a href="{{ route('discount.create') }}" class="btn btn-success float-end" id="btn-new">Add Discount</a>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                @foreach ($discounts as $discount)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('discount.show', $discount->id) }}" class="btn btn-sm btn-secondary">Show</a>
                                            <a href="{{ route('discount.edit', $discount->id) }}" class="btn btn-sm btn-primary">Edit</a>
